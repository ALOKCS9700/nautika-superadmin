  ...
  async function saveCommodity(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (bannerFile) {
        ...
        const uploadResponse = await fetch("https://vertex-fx.onrender.com/admin/intro/upload-image", {
          method: "POST",
          body: bannerFormData
        });
      ...
      const payload = {
        ...
        introBanner: bannerUrl ? `https://vertex-fx.onrender.com${bannerUrl}` : formState.introBanner.value
      };

      const url = isEdit
        ? `https://vertex-fx.onrender.com/admin/intro/update/${intro._id}`
        : "https://vertex-fx.onrender.com/admin/intro/add";
