...
const api = axios.create({
    baseURL: "https://oglitz-backend-node.onrender.com/api/nautika/galleries",
});
const api2 = axios.create({
    baseURL: "https://oglitz-backend-node.onrender.com/admin/nautika/galleries",
});
const uploadApi = axios.create({
    baseURL: "https://oglitz-backend-node.onrender.com/admin/intro",
});
