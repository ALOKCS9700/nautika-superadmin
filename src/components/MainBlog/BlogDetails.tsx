...
async function detectIntent(projectId, sessionId, text) {
  ...
  return response.queryResult.fulfillmentText;
    ...
    const selectedBlog = demoBlogs.find((b: any) => b.id === parseInt(id));
    if (selectedBlog) {
      const blogWithFormattedDate = {
        ...selectedBlog,
        formattedDate: formatDate(selectedBlog.createdAt) // Add formatted date here
      };
      setBlog(blogWithFormattedDate); // Update the state with the new blog object
    }
  }, [id]);
    ...
    <div className="blog-details-container">
      ...
      <div className="blog-details-header">
        ...
        <div className="blog-details-share">
          <i className="fab fa-whatsapp blog-details-share-icon" onClick={handleWhatsAppShare}></i>
      ...
      <div className="blog-details-content">
        <img src={blog.bannerImage} alt={blog.title} className="blog-details-banner" />
