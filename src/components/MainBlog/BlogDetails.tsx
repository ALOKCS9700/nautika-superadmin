  ...
  useEffect(() => {
    const fetchBlogDetails = async () => {
      try {
        ...
        const response = await fetch(`https://cms-backend-ftz7.onrender.com/api/nautika/blogs/${id}`);
        ...
        const relatedResponse = await fetch(`https://cms-backend-ftz7.onrender.com/api/nautika/blogs/category/${data.categoryId}`);
