...
const BlogsList = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await fetch('http://134.209.156.80:5001/api/nautika/categories');
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      ...
      try {
        ...
        const response = await fetch('http://134.209.156.80:5001/api/nautika/blogs/search', {
          method: 'POST',
          headers: {
