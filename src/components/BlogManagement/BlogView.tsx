...
const BlogView: React.FC = () => {
    ...
    useEffect(() => {
        ...
        async function fetchBlog() {
            try {
                const response = await axios.get(`https://oglitz-backend-node.onrender.com/admin/nautika/blogs/${blogId}`);
    ...
    const handlePublish = async () => {
        if (blog) {
            try {
                ...
                await axios.put(`https://oglitz-backend-node.onrender.com/admin/nautika/blogs/${blog._id}`, updatedBlog);
